...
export default new Router({
  ...
  routes: [
    ...
    {
      path: '/myRef',   //ref
      component: ()=>import('@/components/module/myRef'),
    },
    {
      path: '/myComputed',  //计算属性
      component: ()=>import('@/components/module/myComputed'),
    },
    {
      path: '/myWatch',  //watch监听
      component: ()=>import('@/components/module/myWatch'),
    },
    {
      path: '/mySet',  //$set
      component: ()=>import('@/components/module/mySet'),
    },
    {
      path: '/myAxios',  //axios
      component: ()=>import('@/components/module/myAxios'),
    }
  ]
})
