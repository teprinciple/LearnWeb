window.onload = function(){
   ...
   var a2 = [7,8,3,2,3,5];
    //交集
    // var a3 = [...new Set(a1.filter(function(v){
    //     return a2.indexOf(v) != -1;
    // }))]
    //var a3 = [...new Set(a1.filter(v=>a2.indexOf(v) != -1))];
    var a3 = [...new Set(a1.filter(v=>new Set(a2).has(v)))];
    //filter()  返回满 足条件的数组
    // a1.filter(function(v,i){ //v =  2 3 4... i = 索引
    //     return v>5
    // })
   //并集
   ...
   //差集
   var a3 = [...new Set(a1.filter(v=>!new Set(a2).has(v)))];
   var a5 = [...new Set(a2.filter(v=>!new Set(a1).has(v)))];
